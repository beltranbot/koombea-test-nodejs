...
describe('CreditCardValidator American Express', () => {
  it('should validate American Express Card starting with 37', () => {
    let validator = CreditCardValidator(AmericanExpress(), '371449635398431');
    expect(validator.validate()).to.be.true
  })

  it('should validate American Express Card starting with 34', () => {
    let validator = CreditCardValidator(AmericanExpress(), '341449635398431');
    expect(validator.validate()).to.be.true
  })

  it('should return false if American Express Card has wrong length > 15', () => {
    let validator = CreditCardValidator(AmericanExpress(), '3714496353984310');
    expect(validator.validate()).to.be.false
  })

  it('should return false if American Express Card has wrong length < 15', () => {
    let validator = CreditCardValidator(AmericanExpress(), '37144963539843');
    expect(validator.validate()).to.be.false
  })
  ...
  it('should return false if American Express Card has wrong inn range', () => {
    ...
    let validator = CreditCardValidator(AmericanExpress(), ("" + head)+ '1449635398431');
    expect(validator.validate()).to.be.false
  })
})
